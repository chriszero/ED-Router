...
namespace ED_Router.UI.Desktop.Helper
{
    /// <summary>
    /// Utility for accessing window IShell* interfaces in order to use them to launch a process unelevated
    /// </summary>
    /// <remarks>
    /// This is required because VoiceAttack is usually ran elevated but we do NOT want to run the browser in elevated mode.
    /// </remarks>
